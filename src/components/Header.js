...
function Header() {
  ...
  return (
    <header className="bg-black fixed  top-0 w-full z-50">
      ...
      <div
        className="flex justify-between items-center h-28 md:h-32 max-w-[1240px] mx-auto px-4"
        id="navbarHeader"
      >
        <Logo />
        ...
        <div
          className={
            nav
              ? 'fixed z-50 left-0 top-24 w-[100%] ease-in-out duration-500 bg-black'
              : 'fixed left-[-100%]'
          }
        >
